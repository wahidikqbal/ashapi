...
config :ashapi, AshapiWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "CU7c73AcAu4UQK6r1fc06RZRYFRFtb5Phl6SZqWzeOcnBlPX7oBDBCS9jWUsaVjd",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:ashapi, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:ashapi, ~w(--watch)]}
  ]
...
config :ashapi, AshapiWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/ashapi_web/router\.ex$"E,
      ~r"lib/ashapi_web/(controllers|live|components)/.*\.(ex|heex)$"E
    ]
  ]
